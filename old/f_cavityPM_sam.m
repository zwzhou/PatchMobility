function [ Ycavity ] = f_cavityPM_sam( Lx,Ly,Lz, nx,ny, freq )
% return same surface patch mobility of a small thickness air cavity:
...
N_pqr_n0 = Lx*Ly*Lz/8;
ipo_0 =  cos(rpi_lz*lefz).*cos(rpi_lz*lefz)./ ((ppi_lx.* qpi_ly) ).^2 ;
...
ipo_2 =  cos(r2pi_lz*lefz).*cos(r2pi_lz*lefz)./ (p2pi_lx).^2 ;
...
ipo_3 = cos(r3pi_lz*lefz).*cos(r3pi_lz*lefz)./ (q3pi_ly).^2 ;
...
ipo_42 = cos(r4pi_lz*lefz).* cos(r4pi_lz*lefz) ;
